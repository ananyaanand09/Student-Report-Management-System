...
void acceptdata()
{
    ...
    cin>>s.prog_m;
    cout<<"ENTER YOUR DATA MINING MARK :";
    cin>>s.arch_m;
    cout<<"ENTER YOUR WRITING SKILL  MARK :";
    cin>>s.writing_sk;
    cout<<"ENTER YOUR LINUX & SHELL SCRIPTING  MARK :";
    cin>>s.alg_m;
...

{
    ...
    while(infile.read(reinterpret_cast<char*>(&s),sizeof(student)))
    {
        ...
        cout<<"\t\t\t\tSTUDENT REGISTARION NUMBER :"<<s.id<<endl<<endl;
        cout<<"\t\t\t\tSTUDENT ROLL NUMBER :"<<s.roll_no<<endl<<endl;
        cout<<"\t\t\t\tPROGRAMMING MARK :"<<s.prog_m<<endl<<endl;
        cout<<"\t\t\t\tDATA MINING MARK :"<<s.arch_m<<endl<<endl;
        cout<<"\t\t\t\tWRITING SKILL MARK :"<<s.writing_sk<<endl<<endl;
        cout<<"\t\t\t\tLINUX & SHELL SCRIPTING MARK :"<<s.alg_m<<endl<<endl;
...

{
    ...
    while(infile.read(reinterpret_cast<char*>(&s),sizeof(student)))
    {
        ...
        cout<<"\t\t\t\tDATA MINING MARK :"<<s.arch_m<<endl;
        cout<<"\t\t\t\tWRITING SKILL MARK :"<<s.writing_sk<<endl;
        cout<<"\t\t\t\tLINUX & SHELL SCRIPTING :"<<s.alg_m<<endl;
        cout<<"\t\t\t\tSUM :"<<s.sum<<endl;
...

{
    ...
    while(infile.read(reinterpret_cast<char*>(&s),sizeof(student)))
    {
        ...
        cout<<"\t\t\t\tDATA MINING MARK :"<<s.arch_m<<endl<<endl;
        cout<<"\t\t\t\tWRITING SKILL MARK :"<<s.writing_sk<<endl<<endl;
        cout<<"\t\t\t\tLINUX & SHELL SCRIPTING :"<<s.alg_m<<endl<<endl;
        cout<<"\t\t\t\tSUM :"<<s.sum<<endl<<endl;
        cout<<"\t\t\t\tAVERAGE :"<<s.average<<endl<<endl;
        cout<<"\t\t\t\t=================================================="<<endl;
        eq=true;
